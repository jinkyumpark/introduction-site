                ...
                <div className="row">
                    ...
                    <div className="col">
                        <p className='' style={{ lineHeight: '2' }}>
                            안녕하세요! 기초가 탄탄한 백엔드 개발자 <b>박진겸</b>입니다.<br />
                            어렸을때 부터 문제 해결을 좋아해 수학과를 갔지만 컴퓨터 과학 수업을 듣고 컴퓨터 과학에 푹 빠졌습니다.<br />
                            컴퓨터 과학은 이론도 흥미롭지만, 무엇보다 <b>세상에 긍정적인 영향을 줄 수 있는</b>게 너무 좋습니다.<br />
