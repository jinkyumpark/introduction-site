                ...
                <div className="row">
                    ...
                    >
                        {section == 0 ? (
                            ...
                            <PostSection posts={posts} name={name} />
                        )}
                    </div>
                </div>
            </div>
                        ...
                        {posts.map((post) => {
                            return (
                                <Link
                                    ...
                                    className="text-dark text-decoration-none hoverEffect"
                                >
