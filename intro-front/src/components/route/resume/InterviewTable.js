                ...
                <div className="col-5 col-md-7 col-lg-8">
                    <OverlayTrigger
                        ...
                        overlay={
                            <Popover>
                                <Popover.Body>
                                    이력서에는 일반적인 자기소개서를 첨부했지만,
                                    인터뷰 형식으로 작성하면 구어체라 읽기도 더
                                    편하고, 관심 있는 부분만 읽으실 수 있기
                                    때문에 더 유저 친화적이지 않을까 생각해서
                                    인터뷰 형식으로 작성해 봤습니다. 일반적인
                                    자기소개서를 선호하시면 옆에 버튼으로
                                    전환하실 수 있습니다.
                                </Popover.Body>
                            </Popover>
                        }
                    ...
                    introductionData == null ? (
                        ...
                        <>
                            <div className="card-header text-center h4">
                                {introductionData.questionTitle}
                            </div>
                            ...
                            <div className="card-body">
                                {questionData == null ? (
                                    ...
                                    questionData.map((data) => {
                                        return (
                                            <div>
                                                <div className="card-title h4 mt-2">
                                                    {data.question}
                                                </div>
                                                <p
