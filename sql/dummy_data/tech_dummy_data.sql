...
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'Git', 'git-icon.png', '버전 컨트롤 시스템');
insert into tech (num, title, icon, content);
values (tech_seq.nextVal, 'HTML', 'html-icon.png', '프론트엔드 마크업');
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'Java', 'java-icon.png', '프로그래밍 언어');
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'jQuery', 'jquery-icon.png', 'JS 라이브러리');
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'JS', 'js-icon.png', '프로그래밍 언어');
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'JSP', 'jsp-icon.png', 'Java Server-side 언어');
insert into tech (num, title, icon, content)
values (tech_seq.nextVal, 'SQL', 'sql-icon.png', 'DB Query 언어');
